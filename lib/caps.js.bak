...
const NATIVE_TESTS = [
  ...
  "ios_hybrid", "ios_loc_serv", "ios_iwd", "ios_sk"
];


// const HYBRID_APP = 'https://artifactory.inf.las1.saucelabs.net:443/artifactory/test-bundles-local/emusim/ios/WebViewsAplenty-iOS11.2-Xcode10-EMUSIM-2174.app.zip'
// const HYBRID_APP = 'https://1drv.ms/u/s!AjNHuppgIa3nhDHkMcLbHunJMPzR'
// const HYBRID_APP = 'https://github.com/sauce-tartar/test-bundles/releases/download/0.0.1/WebViewsAplenty-iOS11.2-Xcode10-EMUSIM-2174.app.zip'
const HYBRID_APP = 'https://github.com/sauce-tartar/test-bundles/releases/download/0.0.2/WebViewsAplenty-iOS11.2-Xcode10-EMUSIM-2174-FeedSDK.app.zip'
...
const APPS = {
  ...
  'iOSHybrid6': HYBRID_APP,
  'iOSHybrid7': HYBRID_APP,
  'iOSHybrid102': HYBRID_APP,
  'iOSHybridWK': HYBRID_APP,
  'Android': 'https://www.dropbox.com/s/33obtsbhw9gpjmy/android-emulator-test-app-1.0.7-normal-debug.apk?dl=1',
  'AndroidHybrid': 'https://www.dropbox.com/s/33obtsbhw9gpjmy/android-emulator-test-app-1.0.7-normal-debug.apk?dl=1',
...
function fixAppiumIosCaps (caps, tt) {
  ...
  if (_.includes(["ios", "ios_loc_serv", "ios_iwd", "ios_sk"], tt)) {
